...
namespace ICT2106WebApp.mod2grp6.TestCase
{
    class TestCases
    {
        ...
        public List<AbstractNode> Images = new List<AbstractNode>
        {
             ...
             new SimpleNode(3, "image", "Image_rId11.png", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Right Align (Ctrl + L)" }, { "Format", "PNG" }, { "Position", "Inline (position determined by text flow)" }, { "WidthEMU", 3205163 }, { "HeightEMU", 2136775 } } }),
             ...
             new SimpleNode(5, "image", "Image_rId13.jpg", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Right Align (Ctrl + R)" }, { "Format", "JPG" }, { "Position", "Horizontal Offset: 2264485, Vertical Offset: 1046" }, { "WidthEMU", 3469535 }, { "HeightEMU", 2312895 } } }),
             new SimpleNode(6, "image", "Image_rId14.jpg", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Justify (Ctrl + J)" }, { "Format", "JPG" }, { "Position", "Horizontal Offset: 0, Vertical Offset: 0" }, { "WidthEMU", 3840480 }, { "HeightEMU", 2560320 } } })
        };
