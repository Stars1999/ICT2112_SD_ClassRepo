...
namespace ICT2106WebApp.mod2grp6.TestCase
{
    class TestCases
    {
        ...
        public List<AbstractNode> Images = new List<AbstractNode>
        {
            ...
            new SimpleNode(3, "image", "Image_rId11.png", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Right Align (Ctrl + R)" }, { "Format", "PNG" }, { "Position", "Inline (position determined by text flow)" }, { "WidthEMU", 32051 }, { "HeightEMU", 21367 } } }),
            ...
            new SimpleNode(5, "image", "Image_rId13.jpg", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Right Align (Ctrl + R)" }, { "Format", "JPG" }, { "Position", "Horizontal Offset: 2264, Vertical Offset: 1046" }, { "WidthEMU", 34695 }, { "HeightEMU", 23128 } } }),
            new SimpleNode(6, "image", "Image_rId14.jpg", new List<Dictionary<string, object>> { new Dictionary<string, object> { { "Alignment", "Justify (Ctrl + J)" }, { "Format", "JPG" }, { "Position", "Horizontal Offset: 0, Vertical Offset: 0" }, { "WidthEMU", 38404 }, { "HeightEMU", 25603 } } })        
        };
